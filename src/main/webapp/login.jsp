    ...
    <div class="container py-5 h-100">
        <div class="row d-flex justify-content-center align-items-center h-100">
            ...
            <div class="col-lg-12">
                ...
                <div class="card-body"
                     style="margin: 0 78px; padding: 20px 62px; border-radius: 22px; border: solid 1px #ccc; background-color: white;">
                    ...
                    <c:if test="${not empty errorCode}">
                        <div class="alert alert-danger" role="alert">
                            <c:choose>
                                <c:when test="${errorCode == 'MISSING_FIELDS'}">Vui lòng nhập đầy đủ tên đăng nhập và mật khẩu.</c:when>
                                <c:when test="${errorCode == 'ACCOUNT_NOT_EXISTS'}">Tài khoản không tồn tại.</c:when>
                                <c:when test="${errorCode == 'SERVER_ERROR'}">Lỗi hệ thống, vui lòng thử lại sau.</c:when>
...
<!-- Kích hoạt label tự động khi input có value -->
<script>
